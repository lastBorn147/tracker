...
public function addParcel(Request $request){
        ...
        $this->validate($request, [
            ...
            $parcel->shipment_status = $request->input('shipment_status');
            $parcel->parcel_weight = $request->input('parcel_weight');
            $parcel->parcel_content = $request->input('parcel_content');
