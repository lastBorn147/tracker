            ...
            <div class="container">
              ...
              <div class="col-md-10 col-lg-10 col-sm-12 col-xs-12">
                ...
                <div class="col-md-6">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                          <tr>
                            ...
                            @if($parcel->shipment_status == "PENDING")
                            <td  class="btn btn-danger">{{ $parcel->shipment_status }}</td>
                            @else
                              <td>{{ $parcel->shipment_status }}</td>
                  ...
                  <cite style="float:left">Enrollment Date: {{date('M j, Y h:i', strtotime($parcel->updated_at))}}</cite>
                  <hr>
              @endforeach
              @else
